      ...
      <DndProvider backend={HTML5Backend}>
        <div className="h-full min-h-screen min-w-screen bg-background    ">
          <div className="flex flex-col bg-none fixed left-8 top-6 gap-52 z-20">
            <button className="elative border-2 border-violet-800 py-2.5 px-5 font-medium uppercase text-violet-500 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-gradient-to-r from-violet-900  to-blue-600 before:transition-transform before:duration-300 before:content-[''] hover:text-white hover:border-violet-800 before:hover:scale-x-100" onClick={handleBackClick}>
              Go Back
            </button>
          </div>
