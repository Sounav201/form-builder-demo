...
export default function Login(){
  ...
  return (
    <div className='bg-slate-900 h-screen md:h-auto  '>
      <Head>
      ...
      <form action="" className="mt-10 space-y-8 text-white dark:text-white">
        ...
        <div>
          ...
          <div className='flex justify-between'>
            <span className='text-sm tracking-wide text-gray-400 dark:text-sky-400 w-max p-3'>Don&apos;t have an account?</span>
            <Link href={'/register'}><button  type="reset" className="-ml-3 w-max p-2" >
              <span className="text-base tracking-wide text-sky-600 dark:text-sky-400 hover:text-white">Register Now</span>
            </button></Link>
          </div>
        </div>
      </form>
