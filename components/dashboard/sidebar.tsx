...
const Sidebar = () => {
    ...
    return (
        <div className={` h-auto bg-gray-900 shadow-2xl ${open ? " w-6/12 md:w-3/12 duration-300 ":" w-1/11 md:w-1/13 duration-300 "}  relative`}>
            <div className=" border-b py-3 mt-1 flex justify-center ">
                ...
                <MdOutlineArrowBackIos size="1.5em" className={`bg-gray-700/75 p-0.5 text-white rounded-full absolute -right-3 top-4 border duration-300 cursor-pointer ${ !open && "rotate-180" }`} onClick={() => setOpen(!open)} />
                ...
                <div className="space-y-3 border-b shadow-sm  border-solid pt-3 pb-5 md:pt-4 md:pb-6 " >
                    ...
                    <div className="">
                        <div className={`flex p-1 md:p-3 text-gray-300  space-x-2 md:space-x-4 hover:bg-blue-900 hover:text-white  cursor-pointer rounded-xl ${open ? "justify-start":"justify-center"} `}>
                            <MdOutlineAllInclusive size="1.5em" className=" text-gray-300 " />
                    ...
                    <div className="">
                        <div className={`flex p-1 md:p-3 text-gray-400  space-x-2 md:space-x-4 hover:bg-blue-900 hover:text-white  cursor-pointer ${open ? "justify-start":"justify-center"} `}>
                            <IoMdArchive size="1.5em" className="text-gray-300" />
