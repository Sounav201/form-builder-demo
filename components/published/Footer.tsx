  ...
  return (
    ...
    <div className='flex flex-row justify-between bg-cetacean text-slate-400 py-2 md:py-2 px-1 md:px-4'>
        <div className='flex items-center ml-2 md:ml-0'>
            <img src="/fulltitle-nav.png" alt="" className='h-[1.25em] md:h-[1.5em] opacity-50'/>
        </div>
        <div className='flex flex-row gap-2'>
            <p className='flex items-center font-semibold font-alegreya hidden lg:flex'>It&apos;s free!</p>
