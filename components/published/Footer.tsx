...
const Footer = () => {
  ...
  return (
    <>
    <div className='flex flex-row justify-between bg-cetacean text-slate-400 py-2 md:py-2 px-1 md:px-4'>
        <div className='flex items-center'>
            <img src="/fulltitle-nav.png" alt="" className='h-[1em] md:h-[1.5em] opacity-40'/>
        </div>
        <div className='flex flex-row gap-2'>
            ...
            <Link href={'/dashboard/home'}>
                ...
                <span className={`relative py-1 px-4 text-xs md:text-lg font-alegreya font-medium`}>Create your own form now</span>
